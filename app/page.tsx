...
export default async function HomePage() {
  ...
  return (
    <div style={{ backgroundColor: '#050505', minHeight: '100vh', paddingBottom: '100px' }}>
      ...
      {/* OBSAH - NYNÍ POSUNUTÝ NAHORU BEZ HERO SEKCE */}
      <div style={{ maxWidth: '1250px', margin: '0 auto', padding: '40px 20px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '40px', alignItems: 'start' }}>
